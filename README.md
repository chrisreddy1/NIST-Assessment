...
- Cybersecurity Consultant: my new role at Oscorp. I will initially report to the IT manager.
...
- Asset Management:
  ...
  - Oscorp uses Microsoft Office 365 and relies exclusively on Software-as-a-Service applications.
  - All data is in Microsoft Azure.
...
- Vulnerability Management:
  - Oscorp has purchased a vulnerability scanner from Qualys.
...
- Network Security:
  ...
  - The IT team has up to date network diagrams. The diagrams include the cloud environment.
...
- Physical Security:
  ...
  - They have a 24/7 monitoring for their research labs and physical facilities.

- Data Security:
  - Oscorp doesn’t have a DLP solution.
  - All data resides in Microsoft Azure and Microsoft Office 365.
...
- Policy:
  ...
  - There is no data governance policy or information classification.
...
- Security Education and Awareness:
  - All employees are required to do an induction web training module. The module includes basic instructions about cybersecurity.
...
- Hire a Cybersecurity Manager or a Chief Information Security Officer.
